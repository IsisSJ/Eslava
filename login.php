    ...
    if ($stmt) {
        ...
        if ($result->num_rows === 1) {
            ...
            if (password_verify($password, $user['password'])) {
                // Login exitoso
                // En la parte del login exitoso, cambia:
            header("Location: index.php");
                // por:
            header("Location: index.php"); // Esto está bien, pero asegúrate de que el archivo exista
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mt-3 p-3 bg-light rounded">
                        <small class="text-muted">
                            ...
                            • Usuario: <strong>admin</strong> | Contraseña: <strong>admin123</strong> (rol admin)<br>
                            • Usuario: <strong>Kioann</strong> | Contraseña: <strong>cliente123</strong> (rol cliente)<br>
